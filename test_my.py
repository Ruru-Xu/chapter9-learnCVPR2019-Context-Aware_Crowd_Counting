...
if __name__=="__main__":
    ...
    img_root='datasets/Shanghai/part_A_final/test_data/images'
    gt_dmap_root='datasets/Shanghai/part_A_final/test_data/ground_truth'
    model_param_path='./checkpoints/epoch_90.pth'
